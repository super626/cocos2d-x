...
GLProgram* Sprite3D::_sprite3dTexturedProgram = nullptr;
GLProgram* Sprite3D::_sprite3dUnTexturedProgram = nullptr;
const static std::string _sprite3dVSFile = "Textured.es2.vert.h";
const static std::string _sprite3dPSTexFile = "Textured.es2.frag.h";
const static std::string _sprite3dPSUnTexFile = "Colored.es2.frag.h";
...
Sprite3D::Sprite3D(): _partMaterials(nullptr), _partcount(0), _model(nullptr)
//, _effect(nullptr)
{
    if(nullptr == _sprite3dTexturedProgram)
    {
        _sprite3dTexturedProgram = new GLProgram();
        _sprite3dTexturedProgram->initWithFilenames(_sprite3dVSFile, _sprite3dPSTexFile);
    }
    else
    {
        _sprite3dTexturedProgram->retain();
    }
    
    if(nullptr == _sprite3dTexturedProgram)
    {
        _sprite3dUnTexturedProgram = new GLProgram();
        _sprite3dUnTexturedProgram->initWithFilenames(_sprite3dVSFile, _sprite3dPSUnTexFile);
    }
    else
    {
        _sprite3dTexturedProgram->retain();
...
Sprite3D::~Sprite3D()
{
    CC_SAFE_RELEASE(_sprite3dTexturedProgram);
    CC_SAFE_RELEASE(_sprite3dUnTexturedProgram);
