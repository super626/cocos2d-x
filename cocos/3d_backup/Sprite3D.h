...
public:
    ...
    GLProgramState* getMeshMaterial(int idx) { return _partMaterials[idx]; }
...
protected:
    ...
    int               _partcount;
    std::vector<GLProgramState*>    _partMaterials;
    
    //Sprite3DEffect*     _effect;
    
    std::string       _path;
public:
    static GLProgram* _sprite3dTexturedProgram;
    static GLProgram* _sprite3dUnTexturedProgram;
    
    const static std::string _sprite3dVSFile, _sprite3dPSTexFile, _sprite3dPSUnTexFile;
